...
def evaluate(args, model, tokenizer, labels, pad_token_label_id, mode, prefix=""):
    eval_examples = args.processor.get_PTB_dev_examples(args.data_dir)
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        tmp_eval_correct, tmp_eval_total = accuracy(logits, label_ids, label_mask, coarse_map=args.coarse_map)
...
def test(args, model, tokenizer, labels, pad_token_label_id, mode, prefix=""):
    eval_examples = args.processor.get_sep_PPCEME_train_examples(args.data_dir)
    eval_features = convert_examples_to_features(
        eval_examples, labels, args.max_seq_length, tokenizer
    )
    all_input_ids = torch.tensor([f.input_ids for f in eval_features], dtype=torch.long)
...
def main():
    ...
    coarse_labels = processor.get_coarse_map(args.data_dir)
    args.coarse_map = coarse_labels
